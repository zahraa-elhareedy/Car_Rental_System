<?php 
    ...
    $statement1 = $conn->prepare("SELECT * from registration where car_plate =? and (NOT((start_date < ? and end_date < ?  )OR( start_date > ? and end_date > ? )))"); 
...
if($cars->num_rows==0){
    ...
    $statement->bind_param("ssss",$prev_date, $car_plate,$state,$start_date);
